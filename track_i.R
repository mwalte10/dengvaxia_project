...
save(cases, file = paste('TEST.cases.nv_', input, '.RData', sep = ''))
save(cases.l, file = paste('TEST.cases.nv.l_', input, '.RData', sep = ''))
save(cases.h, file = paste('TEST.cases.nv.h_', input, '.RData', sep = ''))}
